...
const DEMO_PROPERTIES_INDIA = [
  ...
  {
    plot_id: 'MB-W90799694',
    address: 'Borivali West, Mumbai, Maharashtra',
    price: 4000000,
    size_in_acres: null,
    size: '200 sq.ft',
    zoning_classification: 'Residential',
    listing_url: 'https://www.magicbricks.com/property-details/residential-land-for-sale-in-borivali-west-mumbai-pdpid-W90799694',
    development_score: 62,
    risk_level: 'Medium',
    suitability_summary: 'GOOD compact residential plot in Borivali West via MagicBricks. Freehold property at ₹40 Lakhs. Small plot area (200 sq.ft) suitable for individual home construction. Well-connected locality with metro and suburban rail access. Investment risk: Medium.',
    analysis_details: {
      key_factors: {
  ...
  {
    plot_id: 'MB-B86005830',
    address: 'Sion West, Mumbai, Maharashtra',
    price: 250000000,
    size_in_acres: null,
    size: '937.30 sq.mt',
    zoning_classification: 'Mixed-Use',
    listing_url: 'https://www.magicbricks.com/property-details/residential-land-for-sale-in-sion-west-mumbai-pdpid-B86005830',
    development_score: 79,
    risk_level: 'Medium-Low',
    suitability_summary: 'STRONG redevelopment opportunity in Sion West via MagicBricks. Strategically situated near major highways, educational institutions, hospitals, and public transport. 937.30 sq.mt plot ideal for residential/commercial redevelopment. Investment risk: Medium-Low.',
    analysis_details: {
      key_factors: {
...
const DEMO_LOGS_INDIA = [
  { agent: 'System', message: 'Crew kickoff initiated with sequential process', delay: 0 },
  { agent: 'Data Researcher', message: 'Detected India location — activating 99acres & MagicBricks pipelines', delay: 800 },
  { agent: 'Data Researcher', message: 'Connecting to 99acres.com & magicbricks.com property portals...', delay: 1600 },
  { agent: 'Data Researcher', message: 'Fetching property listings from 99acres & MagicBricks...', delay: 2400 },
  { agent: 'Data Researcher', message: 'Fetching price trends and locality data...', delay: 3200 },
  { agent: 'Data Researcher', message: 'Found 38 properties, filtered to 5 matching criteria', delay: 4500 },
  { agent: 'Data Researcher', message: '\u2713 Task complete: research_properties_data (via 99acres + MagicBricks)', delay: 5500 },
  ...
  { agent: 'API Manager', message: 'Generating professional summary via Sarvam AI...', delay: 13000 },
  { agent: 'API Manager', message: 'Response: 200 OK, 5 properties, 99acres & MagicBricks source metadata', delay: 14000 },
  { agent: 'API Manager', message: '\u2713 Task complete: generate_api_response', delay: 15000 },
  { agent: 'Info Collector', message: 'Aggregating outputs from 3 upstream agents', delay: 16000 },
  { agent: 'Info Collector', message: 'Cross-referencing 99acres & MagicBricks data with price trends...', delay: 17000 },
  { agent: 'Info Collector', message: '\u2713 Task complete: collect_agent_information', delay: 18500 },
  ...
  { agent: 'Presentation', message: '\u2713 Task complete: format_client_presentation', delay: 22000 },
  { agent: 'Supervisor', message: 'Monitoring workflow quality and completeness', delay: 23000 },
  { agent: 'Supervisor', message: 'All 6 tasks completed. 99acres & MagicBricks pipelines verified.', delay: 24000 },
      ...
      if (isIndia) {
        setResults({
          ...
          metadata: {
            avg_score: 75,
            location: loc,
            api_sources: '99acres.com & magicbricks.com',
            currency: 'INR',
          },
          presentation: [
            ...
            `Data Source: 99acres.com & magicbricks.com (India)`,
            `Date: ${new Date().toLocaleDateString('en-IN')}`,
            '',
            'KEY FINDINGS',
            '• 5 properties identified from 99acres.com & magicbricks.com',
            ...
            '',
            'MARKET INSIGHTS (99acres & MagicBricks Price Trends)',
          ...
          supervisor_report: [
            ...
            'DATA SOURCE: 99acres.com & magicbricks.com (India Real Estate Portals)',
            'QUALITY: All outputs meet professional standards',
            '',
            'INDIA PIPELINE DETAILS',
            '• 99acres & MagicBricks listings fetched: 40',
            '• Filtered results: 5 matching criteria',
            '• Price trends data: Available',
            '• Currency: Indian Rupees (INR)',
            '',
            'AGENT PERFORMANCE',
            '1. Data Researcher: 5.5s — 99acres & MagicBricks India pipelines active',
